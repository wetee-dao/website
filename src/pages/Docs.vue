<template>
  <div class="docs-page gradient-body">
    <SectionHead />
    <div class="container section">
      <!-- Hero -->
      <div class="docs-hero-wrap mb-8">
        <div class="pixel-bg-hero" aria-hidden="true">
          <PixelBg :tile-size="6" :gap="4" :max-opacity="0.2" :density="0.2" :wave-speed="0.0015" />
        </div>
        <div class="docs-hero-grid">
          ...
          <aside class="docs-hero-side">
            <div class="docs-hero-side__title">{{ t('docs.quickStart') }}</div>
            <div class="docs-hero-side__list">
              <a
                v-for="link in quickLinks"
                :key="link.href"
                :href="link.href"
                target="_blank"
                class="docs-hero-side__item"
              >
                <span class="docs-hero-side__item-title">{{ link.title }}</span>
                <span class="docs-hero-side__item-arrow">→</span>
              </a>
            </div>
          </aside>
        </div>
      ...
      <div class="docs-grid">
        <a
          ...
          class="docs-card"
        >
          <div class="docs-card__icon" v-html="cat.icon"></div>
          <div class="docs-card__content">
            <h3 class="docs-card__title">{{ cat.title }}</h3>
            <p class="docs-card__desc">{{ cat.desc }}</p>
          </div>
      ...
      <!-- Quick Links -->
      <div class="docs-quick" aria-hidden="true"></div>
    </div>
    <Footer />
  </div>
</template>
...
const categories = computed(() => [
  {
    id: 'products',
    title: t('docs.catProducts'),
    desc: t('docs.catProductsDesc'),
    ...
    url: `${docsUrl.value}/user/products/confidential-service.html`,
  },
  {
    id: 'miner',
    title: t('docs.catMiner'),
    desc: t('docs.catMinerDesc'),
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="16" height="16" rx="2" ry="2"></rect><rect x="9" y="9" width="6" height="6"></rect><line x1="9" y1="1" x2="9" y2="4"></line><line x1="15" y1="1" x2="15" y2="4"></line><line x1="9" y1="20" x2="9" y2="23"></line><line x1="15" y1="20" x2="15" y2="23"></line><line x1="20" y1="9" x2="23" y2="9"></line><line x1="20" y1="14" x2="23" y2="14"></line><line x1="1" y1="9" x2="4" y2="9"></line><line x1="1" y1="14" x2="4" y2="14"></line></svg>`,
    url: `${docsUrl.value}/user/miner/supported-devices.html`,
  },
  {
    id: 'dev',
    title: t('docs.catDev'),
    desc: t('docs.catDevDesc'),
    ...
    url: `${docsUrl.value}/dev/guides/docker-to-tee.html`,
  },
  {
    id: 'golang',
    title: t('docs.catGolang'),
    desc: t('docs.catGolangDesc'),
    ...
    url: `${docsUrl.value}/dev/golang/libos-ego-sdk.html`,
  },
  {
    id: 'api',
    title: t('docs.catApi'),
    desc: t('docs.catApiDesc'),
    ...
    url: `${docsUrl.value}/dev/architecture/three-layer-model.html`,
  },
])

const quickLinks = computed(() => [
  { title: t('docs.linkQuickStart'), href: docsEntryUrl.value },
  { title: t('docs.linkConfService'), href: `${docsUrl.value}/user/products/confidential-service.html` },
  { title: t('docs.linkRunMiner'), href: `${docsUrl.value}/user/miner/install-confidential-wetee-worker-operator-in-cluster.html` },
  { title: t('docs.linkGolangSdk'), href: `${docsUrl.value}/dev/golang/libos-ego-sdk.html` },
  { title: t('docs.linkDeployTee'), href: `${docsUrl.value}/dev/guides/docker-to-tee.html` },
])

const gitbookUrl = docsEntryUrl
</script>
...
.docs-hero-side__title {
  font-size: 13px;
  font-weight: 600;
  letter-spacing: 0.04em;
  text-transform: uppercase;
  color: rgba(var(--g-primary-text-rgb), 0.7);
  margin-bottom: 10px;
}

.docs-hero-side__list {
  display: grid;
  gap: 8px;
}

.docs-hero-side__item {
  display: flex;
  align-items: center;
...
.docs-hero-side__item:hover {
  background: rgba(255, 255, 255, 0.04);
  border-color: var(--flat-border-2);
  transform: translateY(-1px);
}

.docs-hero-side__item-title {
  min-width: 0;
  overflow: hidden;
...
.docs-hero-side__item-arrow {
  flex-shrink: 0;
  color: rgba(var(--g-primary-text-rgb), 0.45);
}
...
.pixel-bg-hero {
  ...
  opacity: 0.55;
  filter: blur(0.15px);
  -webkit-mask-image: radial-gradient(80% 70% at 50% 20%, rgba(0, 0, 0, 1) 0%, rgba(0, 0, 0, 0) 75%);
  mask-image: radial-gradient(80% 70% at 50% 20%, rgba(0, 0, 0, 1) 0%, rgba(0, 0, 0, 0) 75%);
}
...
.docs-hero {
  ...
  &__title {
    ...
    font-weight: 700;
    color: rgba(var(--g-primary-text-rgb), 1);
    margin-bottom: 12px;
  }
...
.docs-btn {
  ...
  &--primary {
    background: rgba(var(--g-primary-text-rgb), 1);
    color: #040406;
  }

  &--outline {
    background: transparent;
    border: 1px solid rgba(var(--g-primary-text-rgb), 0.55);
    color: var(--flat-text-strong);
  }
}
...
.docs-card {
  ...
  &__icon {
    ...
    align-items: center;
    justify-content: center;
    background: var(--flat-accent-weak);
    color: rgba(var(--g-primary-text-rgb), 0.92);
  }
...
.docs-quick {
  &__title {
    font-size: 1.1rem;
    font-weight: 600;
    color: rgba(var(--g-primary-text-rgb), 0.85);
    margin-bottom: 16px;
  }

...
.large-shadow[data-cube^="31"] {
  left: calc(-10em - 2px);
  --color-fr-top: #1a7034cf;
  --color-fr-bottom: #50fa83cf;
}
...
.cube[data-cube$="2"],
.large-shadow[data-cube$="2"] {
  -webkit-transform: translateZ(calc(10em + 2px));
  transform: translateZ(calc(10em + 2px));
}
...
.large-shadow {
  ...
  -webkit-filter: var(--shadow-filter, blur(3em));
  filter: var(--shadow-filter, blur(3em));
  opacity: 0.2;
  will-change: transform;
}
...
@-webkit-keyframes cube-top {
  20% {
    -webkit-transform: translateZ(calc(-10em + 2em));
    transform: translateZ(calc(-10em + 2em));
  }
...
@-webkit-keyframes cube-front-left {
  ...
  40%,
  60% {
    -webkit-transform: translateX(-8em) scaleX(0.2);
    transform: translateX(-8em) scaleX(0.2);
  }
...
@-webkit-keyframes cube-front-right {
  ...
  40%,
  60% {
    -webkit-transform: translateY(8em) scaleY(0.2);
    transform: translateY(8em) scaleY(0.2);
  }
...
@-webkit-keyframes cube-bottom {
  ...
  80%,
  to {
    -webkit-transform: translateZ(calc(-10em + 1px)) scale(0.95);
    transform: translateZ(calc(-10em + 1px)) scale(0.95);
  }

  40%,
  60% {
    -webkit-transform: translateZ(-2em) scale(0.95);
    transform: translateZ(-2em) scale(0.95);
  }
}
...
.shadow-flip {
  ...
  -webkit-transform-origin: top center;
  transform-origin: top center;
  -webkit-filter: var(--shadow-filter, blur(1em));
  filter: var(--shadow-filter, blur(1em));

<template>
  <svg class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <g transform="translate(512 512) scale(1.1) translate(-512 -512)">
      ...
      <rect x="554" y="560" width="300" height="220" rx="28" ry="28" fill="currentColor" fill-opacity="0.92" />
      <path d="M470 355H554M470 670H554M320 465V560M704 465V560" stroke="currentColor" stroke-width="38" stroke-linecap="round" />
    </g>
  </svg>
</template>
